 ...
 * @author admin
 */
public class SupplyProcessRequestsJPanel extends javax.swing.JPanel {
    private JPanel userProcessContainer;
    private UserAccount account;
    private WorkRequest request;

    /**
     * Creates new form SupplyProcessRequestsJPanel
     */
    public SupplyProcessRequestsJPanel(JPanel userProcessContainer, UserAccount account, WorkRequest request) {
        initComponents();
    ...
    private void btnMarkCompleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMarkCompleteActionPerformed
        ...
        request.setResolvedDate(new java.util.Date());
